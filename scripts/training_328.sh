...
CUDA_VISIBLE_DEVICES=$cuda_id python synctalk/core/syncnet_328.py --save_dir ./syncnet_ckpt/$file_name --dataset_dir $data_dir --asr $asr
syncnet_checkpoint_dir=$(ls -v ./syncnet_ckpt/$file_name/*.pth | tail -n 1)
CUDA_VISIBLE_DEVICES=$cuda_id python scripts/train_328.py --dataset_dir $data_dir --save_dir ./checkpoint/$file_name --asr $asr --use_syncnet --syncnet_checkpoint $syncnet_checkpoint_dir
